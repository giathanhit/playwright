...
import { getLocator, getLocatorByPlaceholder } from 'utils/locator-utils';
...
export const stringRememberMe = () => getLocator('xpath=//*[@id="loginForm"]/div[2]/div[1]/div/div/label');

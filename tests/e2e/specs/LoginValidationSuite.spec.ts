...
test.describe('TS-AUTH-001-Login Validation Suite', () => {
  ...
  test('TC-LOGIN-001 - Validate login page visibility', async () => {
    ...
    // Assert
    await expectPageToHaveTitle('Login | Xspire Business Platform');
    await expectElementToBeVisible(LoginPage.imageBrandLogo());
    await expectElementToBeVisible(LoginPage.stringBrandName());
    await expectElementToHaveText(LoginPage.stringBrandName(), 'Xspire Business Platform');
  ...
  test('TC-LOGIN-006 - Should navigate to forgot password page', async () => {
    ...
    await expectPageToHaveTitle('Forgot password? | Xspire Business Platform');
  });
  ...
  test('TC-LOGIN-008 - Should successfully login with valid credentials', async () => {
    ...
    await expectPageToHaveTitle('Xspire Business Platform');
    await expectElementToContainText(HomePage.stringHeaderWelcome(), 'Welcome to Xspire Business Platform!');
